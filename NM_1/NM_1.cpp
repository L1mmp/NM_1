...
double SimpleIterationMethod(double a, double b, double E, double q);
...
double SimpleIterationMethod(double x, double a, double E, double q)
{
	double xn;
	while (abs(xn) <= (1 - q) * E / q)
	{
		// TODO : Завтра доделать, если будет на лекции
	}
}
